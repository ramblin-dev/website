...
<form class="signup-form" name="updates" method="POST" data-netlify="true" data-netlify-honeypot="bot-field" netlify>
  ...
  <p class="signup-honeypot"><label>Leave this field empty: <input name="bot-field" /></label></p>
  <label for="email" class="signup-label">Get updates when something new ships</label>
